...
export function NewPost({getNewPosts}: {getNewPosts: () => void}){
    ...
    return(
        <Dialog.Root open={open} onOpenChange={setOpen}>
            ...
            <Dialog.Portal>
                <Dialog.Overlay onClick={handleOnCloseModal} style={{width: "100vw", height: "100vh", backgroundColor: "rgba(0,0,0,0.8)", position:"fixed", inset: 0}}/>
                <PostContent>
                    {message.success?(
                        <>
                        ...
                        <>
                            ...
                            <CloseModal onClick={handleOnCloseModal}>
