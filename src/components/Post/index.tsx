import { PostContainer, PostImage, Description, AuthorDescription, Actions, Action } from "./styles";
...
export function Post(props: PostProps){
    return(
        <PostContainer>
            <PostHeader createdAt={props.post.createdAt} author={props.post.author}/>
